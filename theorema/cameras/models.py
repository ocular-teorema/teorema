...
class Camera(models.Model):
    ...
    address_secondary = models.CharField(max_length=400, null=True, default=None)
    ...
    uuid = models.BigIntegerField(null=True, default=None)
    time_uuid = models.CharField(max_length=50, default='')
